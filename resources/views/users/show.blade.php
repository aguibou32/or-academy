    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                        <form method="POST" action="" enctype="multipart/form-data" class="p-5 bg-light">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" value="" placeholder="Example: P01">
                        </div>

                        <div class="form-group">
                            <label for="due_date">Due Date and Time</label>
                            <input type="datetime-local" name="due_date" id="due_date" class="form-control @error('due_date') is-invalid @enderror" value="" placeholder="Example: Module Code">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="practical_filename" id="practical_filename" class="form-control @error('practical_filename') is-invalid @enderror" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="solution_filename" id="solution_filename" class="form-control @error('solution_filename') is-invalid @enderror" value="">
