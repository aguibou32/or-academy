        ...
        <div class="col-md-9">
            <div class="card">
              <div class="card-header">
                  <h3 class="text text-secondary">List Of students to add in {{ $module->module_name }}</h3>
                    ...
                    @foreach ($students as $student)
                          ...
                          <tbody>
                            <tr>
                                ...
                                <td>
                                <form  action="{{ route('attach', $student->id) }}" class="">
                                    @csrf
                                    <input type="hidden" name="module_id" id="module_id" value="{{ $module->id }}">
                                    <button class="fa fa-plus fa-lg text-success" onclick="return confirm('Do you want add this student ?')"></button>
                                </form>
                                </td>
                            </tr>
                        </tbody>
